...
import { GiWineBottle, GiLinkedRings, GiWaterSplash, GiCigarette, GiBigDiamondRing, GiBookCover, GiStairsCake, GiStrong, GiScales, GiBookshelf, GiVacuumCleaner } from "react-icons/gi";
...
import { TbToolsKitchen3, TbHanger } from "react-icons/tb";
import { FaRunning } from "react-icons/fa";
import { ToggleGroup, ToggleGroupItem } from "@/components/ui/toggle-group";

interface LadyProfileCardProps {
  profile: Profile;
...
export function LadyProfileCard({ profile, showMessageButton = false }: LadyProfileCardProps) {
                ...
                <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                  <div>
                    ...
                    {profile.virtue_status === "My virtue is unclaimed" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <BsFlower1 className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                    ...
                    {profile.chastity_preference === "Committed to chastity until marriage" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                    ...
                    {profile.modesty_importance === "Modesty is central to my clothing choices" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <TbHanger className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Modesty: </span>
                            {profile.modesty_importance}
                          </div>
                        </div>
                      </div>
                    )}
                    {profile.wears_dresses === "I like wearing dresses and skirts" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <PiDressLight className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Dresses/Skirts: </span>
                            {profile.wears_dresses}
                          </div>
                        </div>
                      </div>
                    )}
                    {(profile.enjoys_cooking_cleaning === "I like cooking and preparing meals" || 
                      profile.enjoys_cooking_cleaning === "I am willing to learn to cook and prepare meals") && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <TbToolsKitchen3 className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Cooking: </span>
                            {profile.enjoys_cooking_cleaning}
                          </div>
                        </div>
                      </div>
                    )}
                    
                    {profile.pregnancy?.includes("Never") && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <IoAlertCircle className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Pregnancy History: </span>
                            {profile.pregnancy}
                          </div>
                        </div>
                      </div>
                    ...
                    {profile.homeschooling_preference && profile.homeschooling_preference !== "Not comfortable homeschooling our children" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <GiBookshelf className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Homeschooling Ability: </span>
                    ...
                    {profile.provider_importance === "I value having a provider for our family" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <GiStrong className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Provider Recognition: </span>
                    ...
                    {profile.homemaker_importance === "I value being a homemaker and caring for our family" && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          <GiVacuumCleaner className="h-6 w-6 mt-0.5 flex-shrink-0" />
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Homemaker Ability: </span>
                            {profile.homemaker_importance}
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    <div className="mb-4">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-sm text-slate-600">
                          ...
                          {profile.smoking_status || "Not provided"}
                        </div>
                      </div>
                    </div>
                    {profile.drug_usage && (
                    ...
                    {profile.daycare_preference && (
                      <div className="mb-4">
                        <div className="flex items-start gap-2">
                          ...
                          <div className="text-sm text-slate-600">
                            <span className="font-semibold">Daycare Preference: </span>
                            {profile.daycare_preference}
                          </div>
                        </div>
                      </div>
